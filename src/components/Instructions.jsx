...
import "../../public/Instructions.css";

export default function Instructions({ start }) {
    const username = loadData('username');
    return (
        <div className="instructions">
            <h1>É muito bom ter você por aqui, {username}! 😁</h1>
            <p>Confira abaixo algumas informações importantes antes de começarmos:</p>
            <br />
            ...
            <br />
            <br />
            <h2>Agora sim, vamos começar! 🥂</h2>
            <button onClick={start}><img src={Confirm} /></button>
        </div>
    )
}